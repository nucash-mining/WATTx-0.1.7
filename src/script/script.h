...
enum opcodetype
{
    ...
    // WATTx Post-Quantum Signature Opcodes (Dilithium/ML-DSA)
    OP_CHECKSIG_DILITHIUM = 0xbb,        // Verify Dilithium signature
    OP_CHECKSIGVERIFY_DILITHIUM = 0xbc,  // Verify and remove from stack
    OP_CHECKMULTISIG_DILITHIUM = 0xbd,   // Multi-sig with Dilithium
