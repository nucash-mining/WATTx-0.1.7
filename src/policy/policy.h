...
/**
 * Default setting for -datacarriersize. WATTx uses larger OP_RETURN data
 * for FCMP commitments (100+ bytes: magic + O + I + C), so increased from 83.
 * Formula: data bytes + 1 (OP_RETURN) + 2 (pushdata opcodes)
 */
static const unsigned int MAX_OP_RETURN_RELAY = 150;
/**
