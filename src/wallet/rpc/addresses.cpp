...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                "\nReturns a new WATTx address for receiving payments.\n"
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new WATTx address, for receiving change.\n"
...
RPCHelpMan addmultisigaddress()
{
    return RPCHelpMan{"addmultisigaddress",
                ...
                "Each key is a WATTx address or hex-encoded public key.\n"
...
public:
    ...
    UniValue operator()(const DilithiumPubKeyHash& id) const { return UniValue(UniValue::VOBJ); }
};
