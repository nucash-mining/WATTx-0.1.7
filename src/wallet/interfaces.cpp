...
#include <wallet/rpc/validators.h>
#include <wallet/rpc/privacy.h>
...
public:
    ...
    void registerRpcs() override
    {
        ...
        commands.push_back(GetValidatorWalletRPCCommands());
        commands.push_back(GetPrivacyRPCCommands());
        commands.push_back(GetMessagingRPCCommands());
