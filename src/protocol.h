...
//////////////////////////////////////////////////
// WATTx Trust Tier System Messages
//////////////////////////////////////////////////

/**
 * The heartbeat message is broadcast by validators to prove uptime.
 * Contains validator ID, block height, block hash, timestamp, and signature.
 * @since WATTx protocol version 1.
 */
inline constexpr const char* HEARTBEAT{"heartbeat"};

/**
 * The getvalidators message requests a list of known validators from a peer.
 * @since WATTx protocol version 1.
 */
inline constexpr const char* GETVALIDATORS{"getvalidators"};

/**
 * The validators message contains a list of known validators and their info.
 * Sent in response to a getvalidators message.
 * @since WATTx protocol version 1.
 */
inline constexpr const char* VALIDATORS{"validators"};

/**
 * The regvalidator message announces a new validator registration.
 * Contains validator public key, stake amount, and pool fee rate.
 * @since WATTx protocol version 1.
 */
inline constexpr const char* REGVALIDATOR{"regvalidator"};

//////////////////////////////////////////////////
// WATTx Encrypted P2P Messaging
//////////////////////////////////////////////////

/**
 * The encmsg message contains an encrypted P2P message.
 * Contains recipient address hash, encrypted payload, and signature.
 * Messages are relayed to peers until delivered.
 * @since WATTx protocol version 1.
 */
inline constexpr const char* ENCMSG{"encmsg"};
...
inline const std::array ALL_NET_MESSAGE_TYPES{std::to_array<std::string>({
    ...
    // WATTx Trust Tier messages
    NetMsgType::HEARTBEAT,
    NetMsgType::GETVALIDATORS,
    NetMsgType::VALIDATORS,
    NetMsgType::REGVALIDATOR,
    // WATTx Encrypted P2P Messaging
    NetMsgType::ENCMSG,
})};
...
enum ServiceFlags : uint64_t {
    ...
    // WATTx: NODE_VALIDATOR means this node is a registered validator
    // participating in the tiered PoS consensus
    NODE_VALIDATOR = (1 << 12),
