...
public:
    ...
    uint32_t nShift{0};          //!< DEPRECATED: Was for Gapcoin prime calculation
    uint256 nAdder{};            //!< DEPRECATED: Was for Gapcoin prime candidate offset
    uint32_t nGapSize{0};        //!< DEPRECATED: Was for Gapcoin prime gap size
    double nGapcoinMerit{0.0};   //!< DEPRECATED: Was for Gapcoin merit value
