...
public:
    ...
    /**
     * Construct and broadcast an AuxPoW (merged-mined) block.
     *
     * @param[in] version      Block version with AUXPOW_VERSION_FLAG set
     * @param[in] timestamp    Block timestamp
     * @param[in] nonce        Block nonce (may be unused for AuxPoW)
     * @param[in] coinbase     WATTx coinbase transaction
     * @param[in] auxpow       The auxiliary proof of work from parent chain
     * @returns if the block was processed, independent of block validity
     */
